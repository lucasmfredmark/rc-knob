...
var Arc = function Arc(_ref) {
  ...
  return React__default.createElement("g", null, background && React__default.createElement(Range, _extends({
    percentageFrom: percentage,
    percentageTo: 1,
    color: background
  }, props)), React__default.createElement(Range, _extends({
    percentageFrom: 0,
...
var Label = function Label(_ref) {
  ...
  }, React__default.createElement("text", _defineProperty({
    style: _objectSpread({
