...
var calcPath = function calcPath(_ref) {
  ...
  var angleToRad = degTorad(angleFrom + angle);
  var largeArcFlag = Math.abs(angle) < 180 ? 0 : 1;
...
var Arc = function Arc(_ref) {
  var percentage = _ref.percentage,
      ...
      props = _objectWithoutProperties(_ref, ["percentage", "color", "background"]);
...
var Pointer = function Pointer(_ref) {
  ...
  }), type === 'rect' && /*#__PURE__*/React__default.createElement("rect", {
    x: -width * 0.5,
    width: width,
    height: height,
    fill: color,
    className: className
  }), type === 'circle' && /*#__PURE__*/React__default.createElement("circle", {
    r: width,
    fill: color,
    className: className
  }));
...
var Knob = function Knob(_ref2) {
  ...
  return /*#__PURE__*/React__default.createElement("div", {
    ...
    return isInternalComponent(child) ? /*#__PURE__*/React__default.cloneElement(child, _objectSpread({
      percentage: percentage,
      size: size,
      value: value,
      angleOffset: angleOffset,
